...
SOURCES = main.cpp args.cpp FSO.cpp debug_gm.cpp coarse_align.cpp dom_fetcher.cpp auto_align.cpp gm_network_controller.cpp gm_server.cpp dom_timing_test.cpp tracking.cpp
